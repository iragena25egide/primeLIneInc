...
const Map = () => {
  return (
    <div className="bg-cover bg-center h-98 py-8" style={{ backgroundImage: "url('public/image/night.png')" }}>
      ...
      <div className="mt-8 md:mt-10 px-4 md:w-1/2 mx-auto text-center">
        <h4 className="text-sm md:text-2xl text-white font-small">
        ...
        <p className="text-1xl text-white mt-4">
